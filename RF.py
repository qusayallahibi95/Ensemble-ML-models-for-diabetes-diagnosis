...
#RF = RandomForestClassifier(n_estimators=150, criterion='gini', max_depth=11, min_samples_split=2, min_samples_leaf=1, min_weight_fraction_leaf=0.0, max_features='log2')


#GridSeatrch Hyperparameter tunning
RF = RandomForestClassifier(n_estimators=102, criterion='entropy', max_depth=10,  min_samples_leaf=1, min_samples_split= 2,max_features='sqrt')


results = model_selection.cross_val_predict(estimator=RF,
                                          X=data_sample,
...
plt.title('Confusion matrix of RF Technique')
