...
ET = ExtraTreesClassifier(n_estimators=37, max_depth=14, min_samples_split=2)


results = model_selection.cross_validate(estimator=ET,
                                          X=data_sample,
...
#scores = cross_val_score(RF, data_sample, data_target_sample, scoring=scoring, cv=kfold, n_jobs=-1)
# report performance
#print('Accuracy of RF = %.3f' % (mean(scores*100)))
